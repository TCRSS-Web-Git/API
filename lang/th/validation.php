...
return [
    ...
    'attributes' => [
        ...
        'birthday' => 'วันเกิด',
        'body' => 'เนื้อหา',
        'body_with_locale' => 'เนื้อหา (:locale)',
        'career_position' => 'ตำแหน่งงาน',
        'career_type' => 'ประเภท',
        'category' => 'หมวดหมู่',
        'certificate' => 'ใบประกาศต่างๆ หรือผลสอบต่างๆ ที่เกี่ยวข้อง',
        'city' => 'เมือง',
        ...
        'family_status' => 'สภานภาพทางครอบครัว',
        'file' => 'ไฟล์',
        'filter' => 'กรอง',
        ...
        'major' => 'สาขาวิชา',
        'message' => 'ข้อความ',
        'meta_title' => 'หัวเรื่อง meta',
        'meta_title_with_locale' => 'หัวเรื่อง meta (:locale)',
        'meta_description' => 'รายละเอียด meta',
        'meta_description_with_locale' => 'รายละเอียด meta (:locale)',
        'middle_name' => 'ชื่อกลาง',
        'military_service' => 'สถานภาพทางทหาร',
        'minute' => 'นาที',
        'mobile' => 'มือถือ',
        'month' => 'เดือน',
        'name' => 'ชื่อ',
        'name_with_locale' => 'ชื่อ (:locale)',
        ...
        'phone' => 'เบอร์โทรศัพท์',
        'position' => 'ตำแหน่ง',
        'position_with_locale' => 'ตำแหน่ง (:locale)',
        ...
        'referee' => 'ผู้ตัดสิน',
        'referees' => 'ผู้ตัดสิน',
        'registered_province' => 'จังหวัดตามทะเบียนบ้าน',
        'reject_reason' => 'เหตุผลที่ปฏิเสธ',
        'remember' => 'จดจำ',
        'restored_at' => 'กู้คืนเมื่อ',
        ...
        'teacher' => 'ครู',
        'terms' => 'ข้อกำหนด',
        'test_description' => 'คำอธิบายทดสอบ',
        'test_locale' => 'ภาษาทดสอบ',
        'test_name' => 'ชื่อการทดสอบ',
        'text' => 'ข้อความ',
        'thumbnail' => 'ภาพขนาดเล็ก',
        'th' => 'ภาษาไทย',
        'time' => 'เวลา',
        'title' => 'หัวเรื่อง',
        'title_with_locale' => 'หัวเรื่อง (:locale)',
