...
trait HasTranslations
{
    ...
    public function translation(?LocaleData $locale): Translation
    {
        ...
        if (! $this->translations->has($locale->locale->value)) {
            $this->translations->put($locale->locale->value, Relation::initializeLocale($this, $locale)); // @phpstan-ignore-line
        }

        return $this->translations->get($locale->locale->value); // @phpstan-ignore-line
    }
}
