...
class CreateOrUpdateProductAndServiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'th.title' => ['required', 'string', 'max:255', Rule::unique('product_and_service_translations', 'title')],
            'en.title' => ['nullable', $requiredIfPublished, 'string', 'max:255', Rule::unique('product_and_service_translations', 'title')],
