...
3. Config custom DNS for your machine ([api.tcrss.test](https://api.tcrss.test)), Make sure url
...
7. Create Database named **_api.tcrss_** (MySQL 8, Collation: utf8mb4_unicode_ci), update `DB_USERNAME`, `DB_PASSWORD` in .env
