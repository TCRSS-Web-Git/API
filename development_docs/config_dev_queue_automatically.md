...
7. กด OK
8. ตั้งค่าให้ Script Queue ทำงานโดยอัตโนมัติ ไปที่ `Settings` > `Tools` > `Startup Tasks`
9. คลิกที่ `+` เลือก `Laravel Queue` (Script ที่สร้างใน Step ก่อนหน้า)
10. ลองปิด PhpStorm แล้วเปิดใหม่ เพื่อทดสอบดูว่า Queue Worker ทำงานหรือไม่
